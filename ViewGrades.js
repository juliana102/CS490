...
if (httpRequest.readyState === XMLHttpRequest.DONE) {
  if (httpRequest.status === 200) {
   ...
   for (x in response) {
     ...
     var scoreRow="<tr><td colspan='2'>Student's Score on Question "+questionID+": "+studentScore+" out of "+questionPoints+"<br> Override Score:<br> <input type='number' name='points' value='"+studentScore+"'+ min='0' max='"+questionPoints+"' </td></tr>";
